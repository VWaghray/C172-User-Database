...
label_name = Label(root, text="User Name : ", font = ("Bell MT", 15, 'bold'), bg = "#4169e1", fg = "#FFE5B4")
label_name.place(relx=0.3,rely=0.2, anchor=CENTER)
entry_name = Entry(root, font = ("Bell MT", 15, 'bold'),  bg = '#00FF00')
entry_name.place(relx=0.6,rely=0.2, anchor=CENTER)
label_email = Label(root, text="Email id : ", font = ("Bell MT", 15, 'bold'), bg = "#4169e1", fg = "#FFE5B4")
label_email.place(relx=0.3,rely=0.3, anchor=CENTER)
entry_email = Entry(root, font = ("Bell MT", 15, 'bold'), bg = '#00FF00')
entry_email.place(relx=0.6,rely=0.3, anchor=CENTER)
label = Label(root, font = ("Bell MT", 15, 'bold'), bg = "#4169e1", fg = "#FFE5B4")
...
user = GetUsers()
btn = Button(root, text="Add user details", command=user.getUser, bg = '#00FF00')
